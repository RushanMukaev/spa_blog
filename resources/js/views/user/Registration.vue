<template>
    <div>
        <div class="w-96 p-3 mx-auto">
            ...
            <input @click.prevent="register" type="submit" value="Регистрация"
                   class="block float-right mx-auto w-32 p-1 bg-sky-400 text-black rounded-lg">
        </div>
    </div>
</template>
