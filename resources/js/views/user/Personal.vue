<template>
    <div class="w-96 p-1 mx-auto">
        ...
        <div class="mb-4">
            ...
            <div class="flex mb-3 items-center">
                <div>
                    ...
                    <a href="#" class="block p-2 w-32 text-center text-sm rounded-3xl bg-sky-500 text-white"
                       @click.prevent="selectFile()">Изображение</a>
                </div>
                <div>
                    <a v-if="image" @click.prevent="image = null" class="ml-3" href="#">Удалить</a>
                </div>
            </div>
            <div v-if="image">
                <img :src="image.url" alt="preview" class="max-w-24">
            </div>
            <div>
        ...
        <div v-if="posts">
            <h1 class="mb-8 pb-8 border-b border-gray-400">Посты</h1>
